...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You have moved into the most standard of all possible kitchens. You begin to take stock of what's here.
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You make out a stove. I guess it's true what they say, if you're looking for a stove, go to TextWorld. The stove is ordinary.[if there is something on the s_2] On the stove you can make out [a list of things on the s_2].[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " You make out an antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1]. Huh, weird.[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You rest your hand against a wall, but you miss the wall and fall onto a king-size bed. [if there is something on the s_0]You see [a list of things on the s_0] on the king-size bed. You can't wait to tell the folks at home about this![end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "If you're wondering why everything seems so ordinary all of a sudden, it's because you've just walked into the backyard.

 You smell a pungent smell, and follow it to a set of chairs. The set of chairs is standard.[if there is something on the s_10] On the set of chairs you see [a list of things on the s_10].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a bbq. The bbq is ordinary.[if there is something on the s_8] On the bbq you can make out [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You bend down to tie your shoe. When you stand up, you notice a patio table. [if there is something on the s_9]On the patio table you make out [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You've entered a living room.
 ...
 Oh wow! Is that what I think it is? It is! It's a couch! The couch is standard.[if there is something on the s_5] On the couch you can see [a list of things on the s_5]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You can see a tv. [if there is something on the s_7]On the tv you see [a list of things on the s_7]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " You make out a sink. Wow, isn't TextWorld just the best? [if there is something on the s_4]On the sink you make out [a list of things on the s_4].[end if]".
